...
buttonAdd = Button(window, text="+", fg="white", bg="green", font=("Arial", 14),
command=Add)
buttonAdd.place(x=74, y=262, height=32, width=56)

buttonSub = Button(window, text="-", fg="white", bg="green", font=("Arial", 14),
command=Diff)
buttonSub.place(x=142, y=262, height=32, width=56)
buttonMul = Button(window, text="x", fg="white", bg="green", font=("Arial", 14),
command=Mul)
buttonMul.place(x=210, y=262, height=32, width=56)
buttonDiv = Button(window, text="/", fg="white", bg="green", font=("Arial", 14),
command=Div)
